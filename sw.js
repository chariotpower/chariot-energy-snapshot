const CACHE='chariot-energy-snapshot-v2-20260901d';
const ASSETS=['./','./index.html','./styles.css?v=20260901c','./i18n.js?v=20260901d','./app.js?v=20260901c','./chariot-logo.svg','./manifest.webmanifest','./icon-192.png','./icon-512.png','./og-image.png'];
