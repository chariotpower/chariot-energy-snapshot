const CACHE='chariot-energy-snapshot-v3-20260902l';
const ASSETS=['./','./index.html','./styles.css?v=20260902l','./i18n.js?v=20260902l','./app.js?v=20260902l','./analytics.js?v=20260902l','./chariot-logo.svg','./manifest.webmanifest','./icon-192.png','./icon-512.png','./og-image.png'];
