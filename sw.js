const CACHE='chariot-energy-snapshot-v3-20260902k';
const ASSETS=['./','./index.html','./styles.css?v=20260902k','./i18n.js?v=20260902k','./app.js?v=20260902k','./analytics.js?v=20260902k','./chariot-logo.svg','./manifest.webmanifest','./icon-192.png','./icon-512.png','./og-image.png'];
