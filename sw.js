const CACHE='chariot-energy-snapshot-v2-20260901e';
const ASSETS=['./','./index.html','./styles.css?v=20260901d','./i18n.js?v=20260901e','./app.js?v=20260901d','./chariot-logo.svg','./manifest.webmanifest','./icon-192.png','./icon-512.png','./og-image.png'];
