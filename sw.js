const CACHE='chariot-energy-snapshot-v2-20260901b';
const ASSETS=['./','./index.html','./styles.css?v=20260901b','./app.js?v=20260901b','./manifest.webmanifest','./icon-192.png','./icon-512.png','./og-image.png'];
